"""Extract all resources data from resources.html to JSON"""
import json
import re

# Read the HTML file
with open('c:/2026_AI_Collaboration/aiseries/resources.html', 'r', encoding='utf-8') as f:
    content = f.read()

# Find the sections array in the renderResources function
# Extract the JavaScript array definition
...
# Manual extraction since it's JavaScript, not JSON
...
print("Extracted first 2 sections. Now I need to extract all 7 sections from the HTML file.")
print("Let me read the complete sections array from the file...")
